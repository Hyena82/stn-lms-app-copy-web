...
class CourseReviewTabWidget extends StatelessWidget {
    ...
    return Scaffold(
        body: Obx(() {
          ...
          return ListView(
            ...
            children: [
              controller.courseReviews.isEmpty
                  ? Container(
                  ...
                  : Container(
                      ...
                      child: Obx(() {
                        return Row(
                          ...
                          children: [
                            Text(
                              '${controller.courseReviews.length} ${"lượt đánh giá"}',
              ...
              controller.courseReviews.isEmpty
                  ...
                  : ListView.builder(
                      shrinkWrap: true,
                      itemCount: controller.courseReviews.length,
                      physics: const NeverScrollableScrollPhysics(),
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: thumbnailImage(
                                      controller
                                          .courseReviews[index].userAvatar,
                                      fit: BoxFit.fitWidth),
                                ),
                              ),
                              Expanded(
                              ...
                              children: <Widget>[
                                ...
                                Obx(() {
                                  return LayoutUtils.button(
                                      text: 'Gửi Đánh Giá',
                                      readonly: controller
                                          .isSubmittingCourseReview.value,
                                      onPressed: () async {
                                        await controller.submitCourseReview(
